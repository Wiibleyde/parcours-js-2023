function pronoun(str) {
    ...
    for (var i = 0 ; i < arr.length ; i++) {
        if (/^i$/i.test(arr[i])) {
            ...
            obj["i"]["count"] === undefined ? (obj["i"]["count"] = 1) : obj["i"]["count"]++
            ...
            obj["you"]["count"] === undefined ? (obj["you"]["count"] = 1) : obj["you"]["count"]++
            ...
            obj["he"]["count"] === undefined ? (obj["he"]["count"] = 1) : obj["he"]["count"]++
            ...
            obj["she"]["count"] === undefined ? (obj["she"]["count"] = 1) : obj["she"]["count"]++
            ...
            obj["it"]["count"] === undefined ? (obj["it"]["count"] = 1) : obj["it"]["count"]++
            ...
            obj["they"]["count"] === undefined ? (obj["they"]["count"] = 1) : obj["they"]["count"]++
            ...
            obj["we"]["count"] === undefined ? (obj["we"]["count"] = 1) : obj["we"]["count"]++
